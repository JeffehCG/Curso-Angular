...
export class SnackbarComponent implements OnInit {
  ...
  ngOnInit() {
    this.notificationService.notifier //Quando for enviada uma mensagem pelo serviço sera disparada essa função
      .do(message=>{ //do recebe o parametro passado, e faz algo com ele antes do subscrib
        this.message = message
        this.snackVisibility = 'visible'
    })
      //Timer, depois de 3 segundos ele volta para hidden, assim escondendo o snackBar
      .switchMap(message => Observable.timer(3000)) //switchmap troca o observable quando são chamados varios em seguida, ou seja, o timer ira ser zerado 
